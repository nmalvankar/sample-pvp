...
public class KiePVPTest extends KieTestUtilsIT {
    ...
    public void testLocalProcessVariablePersistence() throws InterruptedException {
        ...
        assertEquals(1, jdbcTemplate.queryForObject("SELECT COUNT(*) FROM MappedVariable WHERE processInstanceId = ?",
                new Object[]{processInstanceId}, Integer.class).intValue());
